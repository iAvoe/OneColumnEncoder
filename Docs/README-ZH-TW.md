...
- 為 FFMPEG-VS-AVS 生成多種濾鏡：
  ...
  - SAR 修復
  - 縮放
- 為 VapourSynth 提供額外的 OpenCL 降噪、去色帶與模糊濾鏡
...
- [x] OpenCL 兼容性检查
- [x] VapourSynth-zipcl 已集成，且提供了部分自動生成的導入、降噪、去色帶和模糊濾鏡範例
- [x] VapourSynth 預覽器已實現，界面和壓制預覽器一致
- [ ] 利用 Nuget 包插件列出 OpenCL 設備？
- [ ] 驗證隊列模式、合併模式下使用擴展濾鏡的壓制結果
