namespace OneColumnEncoder.Helpers
{
    public static class ScriptTemplateH
    {
        ...
        public static string BuildAvsExportScript(string sourcePath, string avsPrefix2, string avsSuffix, string userInput = "")
        {
        ...
        public static string BuildVpyExportScript(string sourcePath, string vpyPrefix2, string vpySuffix, string userInput = "")
        {
            string content = string.IsNullOrEmpty(userInput)
                ? $"\r\n{vpyPrefix2}\r\n\r\n{vpySuffix}"
                : $"\r\n{vpyPrefix2}\r\n{userInput}\r\n{vpySuffix}";
            return $"{BuildVpySourceHeader(sourcePath)}{content}";
        }
