...
public class AppConfLangProviderM
{
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["Setting.Bypass.SrcValGroup"] = "Always bypass Source Validation Checklists",
            ["Setting.Bypass.EncTermsValGroup"] = "Always bypass Encoding Terms Validation Group",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["Setting.Bypass.SrcValGroup"] = "默认绕过视频源检查列表",
            ["Setting.Bypass.EncTermsValGroup"] = "默认绕过开始压制前提",
            ["AppConf.Cancel"] = "取消",
            ["AppConf.Save"] = "保存",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["Setting.Bypass.SrcValGroup"] = "默認繞過影片源檢查列表",
            ["Setting.Bypass.EncTermsValGroup"] = "默認繞過開始壓制前提",
            ["AppConf.Cancel"] = "取消",
            ["AppConf.Save"] = "保存",
        ...
        ["fr"] = new()
        {
            ...
            ["Setting.Bypass.SrcValGroup"] = "Toujours ignorer les listes de contrôle de validation source",
            ["Setting.Bypass.EncTermsValGroup"] = "Toujours ignorer la validation des conditions d'encodage",
        ...
        ["es"] = new()
        {
            ...
            ["Setting.Bypass.SrcValGroup"] = "Omitir siempre las listas de verificación de fuente",
            ["Setting.Bypass.EncTermsValGroup"] = "Omitir siempre la validación de términos de codificación",
        ...
        ["ja"] = new()
        {
            ...
            ["Setting.Bypass.SrcValGroup"] = "常にソース検証チェックリストをバイパス",
            ["Setting.Bypass.EncTermsValGroup"] = "常にエンコード条件検証をバイパス",
        ...
        ["ru"] = new()
        {
            ...
            ["Setting.Bypass.SrcValGroup"] = "Всегда пропускать проверку исходного видео",
            ["Setting.Bypass.EncTermsValGroup"] = "Всегда пропускать проверку условий кодирования",
