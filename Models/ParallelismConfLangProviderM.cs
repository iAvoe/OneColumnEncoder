...
public class ParallelismConfLangProviderM
{
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ...
        ["fr"] = new()
        {
            ...
            ["ThreadStrategyTitle"] = "Hyper-threading et planification des coeurs P/E",
            ["EncoderThreadCountText"] = "Threads encodeur",
            ["PreferUpstreamPhysCoresText"] = "Limiter l'amont aux coeurs physiques",
            ["PreferDownstreamPhysCoresText"] = "Limiter l'encodeur aux coeurs physiques",
            ...
            ["CorePerGroup1"] = " coeurs est directement relié à ",
            ["CorePerGroup1alt"] = " coeurs (",
        ...
        ["es"] = new()
        {
            ...
            ["CorePerGroup1"] = " núcleos está conectado directamente a ",
            ["CorePerGroup1alt"] = " núcleos (",
            ["CorePerGroup1alt1"] = " hilos) está conectado directamente a ",
