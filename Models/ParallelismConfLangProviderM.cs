...
public class ParallelismConfLangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["PriorityText"] = "This program doesn't adjust process priority or declare encoding task to be latency-sensitive, to avoid an unresponsive encoder halting the OS indefinitely.",
