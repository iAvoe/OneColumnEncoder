...
public sealed class MuxLangProvider(string languageCode) : LangProviderBase(languageCode, Data)
{
    ...
    static MuxLangProvider()
    {
        ...
        foreach (var pair in new Dictionary<string, string>
        {
            ...
            ["MuxTracks.NoSub"] = "Pas de sous-titres",
        ...
        foreach (var pair in new Dictionary<string, string>
        {
            ...
            ["MuxTracks.NoSub"] = "Sin subtítulos",
        ...
        foreach (var pair in new Dictionary<string, string>
        {
            ...
            ["MuxTracks.NoSub"] = "Субтитры отсутствуют",
        ...
        foreach (var pair in new Dictionary<string, string>
        {
            ...
            ["MuxTracks.NoSub"] = "Keine untertitel",
