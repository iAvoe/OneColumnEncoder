...
public sealed class RepartLangProvider(string languageCode)
{
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["LockDivider"] = "Lock",
            ["UnlockDivider"] = "Unlock",
            ["InvertSelection"] = "Invert",
            ["SelectLeftDivider"] = "<- Select",
            ["SelectRightDivider"] = "Select ->",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["UnlockDivider"] = "解锁",
            ["InvertSelection"] = "反选",
            ["SelectLeftDivider"] = "←选择",
            ["SelectRightDivider"] = "选择→",
    ...
    static RepartLangProvider()
    {
        Data["zh-tw"] = new(Data["zh-cn"])
        {
            ...
            ["UnlockDivider"] = "解鎖",
            ["InvertSelection"] = "反選",
            ["SelectLeftDivider"] = "←選擇",
            ["SelectRightDivider"] = "選擇→",
        ...
        Data["fr"] = new(Data["en"])
        {
            ...
            ["LockDivider"] = "Verrouiller",
            ["UnlockDivider"] = "Déverrouiller",
            ["InvertSelection"] = "Inverser",
            ["SelectLeftDivider"] = "<- Sélectionner",
            ["SelectRightDivider"] = "Sélectionner ->",
        ...
        Data["es"] = new(Data["en"])
        {
            ...
            ["LockDivider"] = "Bloquear",
            ["UnlockDivider"] = "Desbloquear",
            ["InvertSelection"] = "Invertir",
            ["SelectLeftDivider"] = "<- Seleccionar",
            ["SelectRightDivider"] = "Seleccionar ->",
        ...
        Data["ja"] = new(Data["en"])
        {
            ...
            ["UnlockDivider"] = "ロック解除",
            ["InvertSelection"] = "反転",
            ["SelectLeftDivider"] = "←選択",
            ["SelectRightDivider"] = "選択→",
        ...
        Data["ru"] = new(Data["en"])
        {
            ...
            ["LockDivider"] = "Закрепить",
            ["UnlockDivider"] = "Открепить",
            ["InvertSelection"] = "Инвертировать",
            ["SelectLeftDivider"] = "←выбрать",
            ["SelectRightDivider"] = "выбрать→",
