...
public sealed class RepartLangProvider(string languageCode) : LangProviderBase(languageCode, Data)
{
    ...
    static RepartLangProvider()
    {
        ...
        Data["de"] = new(Data["en"])
        {
            ...
            ["TimelineHintDetailed"] = "Modus für verbundene Disks (Unter-/Übersegmentierung) oder fehlerhafte Episodentrennung. Erfordert manuelle Prüfung. Kapitelimport erzeugt überzählige Trennlinien (OP, ED, Boni) — löschen für korrekte Aufteilung",
        ...
        Data["pt-br"] = new(Data["en"])
        {
            ...
            ["TimelineHintDetailed"] = "Este modo é para discos conjugados (sub/sobre-segmentados) ou para fontes com divisões de episódios perdidas. Este modo precisa de inspeção manual. A importação por capítulos criará divisórias excessivas para OP, ED, mini-show, etc.; exclua-as para corrigir totalmente as partições de episódios",
