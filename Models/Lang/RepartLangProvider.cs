...
public sealed class RepartLangProvider(string languageCode) : LangProviderBase(languageCode, Data)
{
    ...
    static RepartLangProvider()
    {
        ...
        Data["de"] = new(Data["en"])
        {
            ...
            ["InterlacedSourcePrompt"] = "Neuteilungsmodus erfordert progressive, scanstabile CFR-Quellen für framegenauen Output.\n\nAbbrechen: Quelle verwerfen und Import fortsetzen.\nBestätigen: Quelle behalten und Import fortsetzen.",
