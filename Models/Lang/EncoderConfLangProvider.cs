...
public class EncoderConfLangProvider : LangProviderBase
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["CrfModeText"] = "CRF Mode",
            ["AbrModeText"] = "ABR Mode",
            ["X264Text"] = "x264",
            ["X265Text"] = "x265",
            ["SvtAv1Text"] = "SVT-AV1",
            ...
            ["DoviSrcOnly"] = "When source is DOVI",
    ...
    static EncoderConfLangProvider()
    {
        Data["fr"] = new(Data["en"])
        {
            ...
            ["CrfModeText"] = "Mode CRF",
            ["AbrModeText"] = "Mode ABR",
            ...
            ["DoviSrcOnly"] = "Lorsque source est DOVI",
        ...
        Data["es"] = new(Data["en"])
        {
            ...
            ["CrfModeText"] = "Modo CRF",
            ["AbrModeText"] = "Modo ABR",
            ...
            ["DoviSrcOnly"] = "Cuando fuente es DOVI",
        ...
        Data["ja"] = new(Data["en"])
        {
            ...
            ["DoviTitle"] = "Dolby Vision 互換性",
            ["DoviOnOff"] = "有効にする条件",
            ["DoviSrcOnly"] = "ソースが DOVI の場合",
            ["X264HrdTitle"] = "x264 HRD（VBV 必須）",
            ["X265HrdTitle"] = "x265 HRD（VBV 必須）",
        ...
        Data["ru"] = new(Data["en"])
        {
            ...
            ["CrfModeText"] = "Режим CRF",
            ["AbrModeText"] = "Режим ABR",
            ...
            ["DoviSrcOnly"] = "Для источника DOVI",
        ...
        Data["de"] = new(Data["en"])
        {
            ...
            ["CrfModeText"] = "CRF-Modus",
            ["AbrModeText"] = "ABR-Modus",
            ...
            ["DoviSrcOnly"] = "Quando fonte é DOVI",
