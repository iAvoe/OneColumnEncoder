...
public class UILangProvider : LangProviderBase
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["Buttons.FilterScribe"] = "Open Filter Scribe",
            ["Buttons.ShowRawJSON"] = "Show Raw JSON",
            ["Buttons.AnalyzeSrcVideo"] = "Run Source Analysis",
            ["Buttons.Fork"] = "Fork",
            ["Buttons.RunSample"] = "Clip Sampling",
            ["Buttons.QueueEditor"] = "Open Queue Editor",
            ["Buttons.RepartEditor"] = "Open Repart Editor",
            ["Buttons.StartEncode"] = "Start Encode",
            ["Errors.ForkSnapshotLoadTitle"] = "Fork State Error",
            ["Errors.ForkSnapshotLoadMessage"] = "The forked instance could not restore its state and will close.\n\nDetails: {0}",
            ...
            ["Tool.Source.AviSynth"] = $"{LangProviderBase.AviSynth} .avs Source",
            ["Tool.Source.VapourSynth"] = $"{LangProviderBase.VapourSynth} .vpy Source",
            ["Tool.Source.Svfi"] = "SVFI .ini Source",
            ["Tool.Source.AviSynthQueue"] = $"📁 {LangProviderBase.AVS} Script Queue",
            ["Tool.Source.VapourSynthQueue"] = $"📁 {LangProviderBase.VS} Script Queue",
            ...
            ["Checklist.Enc1.NotOffGrid"] = "Not off-grid / on AC power",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["Buttons.FilterScribe"] = "滤镜编辑器",
            ["Buttons.ShowRawJSON"] = "显示原生 JSON",
            ["Buttons.AnalyzeSrcVideo"] = "运行视频源分析",
            ["Buttons.Fork"] = "分身",
            ["Buttons.RunSample"] = "取段打样",
            ["Buttons.QueueEditor"] = "队列编辑器",
            ["Buttons.RepartEditor"] = "打开重分集编辑器",
            ["Buttons.StartEncode"] = "开始压制",
            ["Errors.ForkSnapshotLoadTitle"] = "分身状态错误",
            ["Errors.ForkSnapshotLoadMessage"] = "分身实例无法恢复其状态，即将关闭。\n\n详细信息：{0}",
            ...
            ["Tool.Source.AviSynth"] = $"{LangProviderBase.AviSynth} .avs 源",
            ["Tool.Source.VapourSynth"] = $"{LangProviderBase.VapourSynth} .vpy 源",
            ["Tool.Source.Svfi"] = "SVFI .ini 源",
            ["Tool.Source.AviSynthQueue"] = $"📁 {LangProviderBase.AVS} 脚本队列",
            ["Tool.Source.VapourSynthQueue"] = $"📁 {LangProviderBase.VS} 脚本队列",
            ...
            ["Checklist.Enc1.NotOffGrid"] = "非离网 / 使用外接供电",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["Buttons.FilterScribe"] = "濾鏡編輯器",
            ["Buttons.ShowRawJSON"] = "顯示原生 JSON",
            ["Buttons.AnalyzeSrcVideo"] = "運行影片源分析",
            ["Buttons.Fork"] = "分身",
            ["Buttons.RunSample"] = "取段打樣",
            ["Buttons.QueueEditor"] = "隊列編輯器",
            ["Buttons.RepartEditor"] = "打開重分集編輯器",
            ["Buttons.StartEncode"] = "開始壓制",
            ["Errors.ForkSnapshotLoadTitle"] = "分身狀態錯誤",
            ["Errors.ForkSnapshotLoadMessage"] = "分身執行個體無法還原其狀態，即將關閉。\n\n詳細資訊：{0}",
            ...
            ["Tool.Source.AviSynth"] = $"{LangProviderBase.AviSynth} .avs 來源",
            ["Tool.Source.VapourSynth"] = $"{LangProviderBase.VapourSynth} .vpy 來源",
            ["Tool.Source.Svfi"] = "SVFI .ini 來源",
            ["Tool.Source.AviSynthQueue"] = $"📁 {LangProviderBase.AVS} 腳本隊列",
            ["Tool.Source.VapourSynthQueue"] = $"📁 {LangProviderBase.VS} 腳本隊列",
            ...
            ["Checklist.Enc1.NotOffGrid"] = "非離網 / 使用外接供電",
    ...
    private static void AddFrench() => Data["fr"] = new(Data["en"])
    {
        ...
        ["Buttons.FilterScribe"] = "Éditeur filtres",
        ["Buttons.ShowRawJSON"] = "Afficher JSON brut",
        ["Buttons.AnalyzeSrcVideo"] = "Analyser source",
        ["Buttons.Fork"] = "Fork",
        ["Buttons.RunSample"] = "Échant. clip",
        ["Buttons.QueueEditor"] = "Éditeur de file d'attente",
        ["Buttons.RepartEditor"] = "Ouvrir l'éditeur de répartition",
        ["Buttons.StartEncode"] = "Lancer enc.",
        ["Errors.ForkSnapshotLoadTitle"] = "Erreur d’état du fork",
        ["Errors.ForkSnapshotLoadMessage"] = "L’instance forkée n’a pas pu restaurer son état et va se fermer.\n\nDétails : {0}",
    ...
    private static void AddSpanish() => Data["es"] = new(Data["en"])
    {
        ...
        ["Buttons.FilterScribe"] = "Editor de filtros",
        ["Buttons.ShowRawJSON"] = "Mostrar JSON bruto",
        ["Buttons.AnalyzeSrcVideo"] = "Analizar fuente",
        ["Buttons.Fork"] = "Bifurcar",
        ["Buttons.RunSample"] = "Muestra clip",
        ["Buttons.QueueEditor"] = "Editor de cola de espera",
        ["Buttons.RepartEditor"] = "Abrir el editor de repartición",
        ["Buttons.StartEncode"] = "Iniciar cod.",
        ["Errors.ForkSnapshotLoadTitle"] = "Error de estado del fork",
        ["Errors.ForkSnapshotLoadMessage"] = "La instancia bifurcada no pudo restaurar su estado y se cerrará.\n\nDetalles: {0}",
    ...
    private static void AddJapanese() => Data["ja"] = new(Data["en"])
    {
        ...
        ["Buttons.FilterScribe"] = "フィルタ編集",
        ["Buttons.ShowRawJSON"] = "生 JSON を表示",
        ["Buttons.AnalyzeSrcVideo"] = "ソース解析",
        ["Buttons.Fork"] = "フォーク",
        ["Buttons.RunSample"] = "クリップ試作",
        ["Buttons.QueueEditor"] = "キューエディター",
        ["Buttons.RepartEditor"] = "再分割エディターを開く",
        ["Buttons.StartEncode"] = "エンコード開始",
        ["Errors.ForkSnapshotLoadTitle"] = "フォーク状態エラー",
        ["Errors.ForkSnapshotLoadMessage"] = "フォークしたインスタンスの状態を復元できないため、終了します。\n\n詳細: {0}",
    ...
    private static void AddRussian() => Data["ru"] = new(Data["en"])
    {
        ...
        ["Buttons.FilterScribe"] = "Редактор фильтров",
        ["Buttons.ShowRawJSON"] = "Показать исходный JSON",
        ["Buttons.AnalyzeSrcVideo"] = "Анализ источника",
        ["Buttons.Fork"] = "Форк",
        ["Buttons.RunSample"] = "Пробный клип",
        ["Buttons.QueueEditor"] = "Редактор очереди",
        ["Buttons.RepartEditor"] = "Открыть редактор разбиения",
        ["Buttons.StartEncode"] = "Нач. кодир.",
        ["Errors.ForkSnapshotLoadTitle"] = "Ошибка состояния форка",
        ["Errors.ForkSnapshotLoadMessage"] = "Не удалось восстановить состояние экземпляра форка. Он будет закрыт.\n\nПодробности: {0}",
    ...
    private static void AddGerman() => Data["de"] = new(Data["en"])
    {
        ...
        ["Buttons.FilterScribe"] = "Filter-Editor",
        ["Buttons.ShowRawJSON"] = "Roh-JSON anzeigen",
        ["Buttons.AnalyzeSrcVideo"] = "Quelle analysieren",
        ["Buttons.Fork"] = "Fork",
        ["Buttons.RunSample"] = "Clip-Abtastung",
        ["Buttons.QueueEditor"] = "Warteschlangen-Editor",
        ["Buttons.RepartEditor"] = "Neuteilungs-Editor öffnen",
        ["Buttons.StartEncode"] = "Kodierung starten",
        ["Errors.ForkSnapshotLoadTitle"] = "Fehler beim Fork-Zustand",
        ["Errors.ForkSnapshotLoadMessage"] = "Der Fork konnte seinen Zustand nicht wiederherstellen und wird geschlossen.\n\nDetails: {0}",
    ...
    private static void AddKorean() => Data["ko"] = new(Data["en"])
    {
        ...
        ["Buttons.FilterScribe"] = "필터 편집기 열기",
        ["Buttons.ShowRawJSON"] = "원본 JSON 표시",
        ["Buttons.AnalyzeSrcVideo"] = "소스 분석 실행",
        ["Buttons.Fork"] = "포크",
        ["Buttons.RunSample"] = "클립 샘플",
        ["Buttons.QueueEditor"] = "대기열 편집기",
        ["Buttons.RepartEditor"] = "재분할 편집기 열기",
        ["Buttons.StartEncode"] = "인코딩 시작",
        ["Errors.ForkSnapshotLoadTitle"] = "포크 상태 오류",
        ["Errors.ForkSnapshotLoadMessage"] = "포크 인스턴스의 상태를 복원하지 못해 종료합니다.\n\n세부 정보: {0}",
    ...
    private static void AddPortuguese() => Data["pt-br"] = new(Data["en"])
    {
        ...
        ["Buttons.FilterScribe"] = "Abrir editor de filtros",
        ["Buttons.ShowRawJSON"] = "Mostrar JSON bruto",
        ["Buttons.AnalyzeSrcVideo"] = "Executar análise da fonte",
        ["Buttons.Fork"] = "Bifurcar",
        ["Buttons.RunSample"] = "Amostra clipe",
        ["Buttons.QueueEditor"] = "Editor de fila de espera",
        ["Buttons.RepartEditor"] = "Abrir editor de repartição",
        ["Buttons.StartEncode"] = "Iniciar codificação",
        ["Errors.ForkSnapshotLoadTitle"] = "Erro de estado do fork",
        ["Errors.ForkSnapshotLoadMessage"] = "A instância bifurcada não pôde restaurar seu estado e será fechada.\n\nDetalhes: {0}",
