...
public class UILangProvider : LangProviderBase
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["Tool.Source.VideoSrcConcatState"] = "∪ Video Src. Concat",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["Tool.Source.VideoSrcConcatState"] = "∪ 视频源拼接",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["Tool.Source.VideoSrcConcatState"] = "∪ 視訊源拼接",
    ...
    private static void AddFrench() => Data["fr"] = new(Data["en"])
        {
            ...
            ["Tool.Source.VideoSrcConcatState"] = "∪ Concat source vidéo",
    ...
    private static void AddSpanish() => Data["es"] = new(Data["en"])
        {
            ...
            ["Tool.Source.VideoSrcConcatState"] = "∪ Concat vídeo",
    ...
    private static void AddJapanese() => Data["ja"] = new(Data["en"])
        {
            ...
            ["Tool.Source.VideoSrcConcatState"] = "∪ 動画ソース連結",
    ...
    private static void AddRussian() => Data["ru"] = new(Data["en"])
        {
            ...
            ["Tool.Source.VideoSrcConcatState"] = "∪ Конкатенация видео",
    ...
    private static void AddGerman() => Data["de"] = new(Data["en"])
        {
            ...
            ["Tool.Source.VideoSrcQueue"] = "📁 Video-Wart.",
            ["Tool.Source.VideoSrcQueueWithCount"] = "📁 Video-Wart. ({0})",
            ["Tool.Source.VideoSrcConcatState"] = "∪ Video-Concat",
            ["Tool.Source.VideoSrcConcatWithCount"] = "∪ Video-Concat ({0})",
            ["Tool.Source.AviSynth"] = "AviSynth .avs-Quelle",
            ["Tool.Source.VapourSynth"] = "VapourSynth .vpy-Quelle",
    ...
    private static void AddKorean() => Data["ko"] = new(Data["en"])
        {
            ...
            ["Tool.Source.VideoSrcQueue"] = "📁 비디오 소스 큐",
            ["Tool.Source.VideoSrcQueueWithCount"] = "📁 비디오 소스 큐 ({0})",
            ["Tool.Source.VideoSrcConcatState"] = "∪ 비디오 소스 연결",
            ["Tool.Source.VideoSrcConcatWithCount"] = "∪ 비디오 소스 연결 ({0})",
            ["Tool.Source.AviSynth"] = "AviSynth .avs 소스",
            ["Tool.Source.VapourSynth"] = "VapourSynth .vpy 소스",
    ...
    private static void AddPortuguese() => Data["pt-br"] = new(Data["en"])
        {
            ...
            ["Tool.Source.VideoSrcConcatState"] = "∪ Concatenação de fontes de vídeo",
            ["Tool.Source.VideoSrcConcatWithCount"] = "∪ Concatenação de fontes de vídeo ({0})",
            ["Tool.Source.AviSynth"] = "Fonte AviSynth .avs",
            ["Tool.Source.VapourSynth"] = "Fonte VapourSynth .vpy",
