...
public class EncodingMonitorModalLangProvider : LangProviderBase
{
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["PageFaultBottomText"] = "Hard and soft",
...
["StopQueueConfirmMessage"] = "Текущая задача прервана. Остановить всю очередь?"
        ...
        Data["de"] = new(Data["en"])
        {
            ...
            ["MuxTimebaseHint"] = "Mux-Ausgabe erbt Timebase von der Quelle, sodass Qualitätsmetriken Frames korrekt ausrichten können ohne manuelle GCD-Berechnung",
            ...
            ["PageFaultBottomText"] = "Hart und weich",
        ...
        Data["pt-br"] = new(Data["en"])
        {
            ...
            ["MuxTimebaseHint"] = "A saída muxada herda o timebase da fonte, para que as métricas de qualidade alinhem os quadros corretamente, sem calcular manualmente o MDC das frações",
            ...
            ["ViewEncodingCommandText"] = "Revisar linha de comando",
            ...
            ["PageFaultBottomText"] = "Rígidas e flexíveis",
