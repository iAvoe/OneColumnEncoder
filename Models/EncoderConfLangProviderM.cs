...
public class EncoderConfLangProviderM
{
    ...
    static EncoderConfLangProviderM()
    {
        Data["fr"] = new(Data["en"])
        {
            ...
            ["CrfModeText"] = "Mode CRF (facteur de débit constant)",
            ...
            ["X265JpsdrTextureText"] = "x265 jpsdr Mod : ↑AQ contours",
            ...
            ["KeyframeHintText2"] = "↑Résolution=↑difficulté décodage/index; ajuster keyint peut réduire l'indexation ou améliorer la compression",
            ["ThirdPartyHintText1"] = "« Grain film » privilégie fortement la netteté, pas la compression",
        ...
        Data["es"] = new(Data["en"])
        {
            ...
            ["CrfModeText"] = "Modo CRF (factor de tasa constante)",
            ...
            ["X265JpsdrTextureText"] = "x265 jpsdr Mod: ↑AQ en bordes",
            ...
            ["KeyframeHintText2"] = "↑Resolución=↑dificultad de decodificar/indexar; ajustar keyint puede bajar dificultad o aumentar compresión",
            ["ThirdPartyHintText1"] = "«Grano» favorece nitidez, no compresión",
        ...
        Data["ru"] = new(Data["en"])
        {
            ...
            ["CrfModeText"] = "Режим CRF (пост. фактор качества)",
            ...
            ["X265JpsdrTextureText"] = "x265 jpsdr Mod: ↑AQ для граней",
            ...
            ["KeyframeHintText2"] = "↑Разрешение=↑сложность декод./индексации; keyint может снизить сложность или повысить сжатие",
