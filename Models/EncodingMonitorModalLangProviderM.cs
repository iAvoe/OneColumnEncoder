...
public class EncodingMonitorModalLangProviderM
{
    ...
    static EncodingMonitorModalLangProviderM()
    {
        Data["fr"] = new(Data["en"])
        {
            ...
            ["DragLogReportHint"] = "Glissez la fenêtre pour redimensionner le journal; glissez le séparateur pour la largeur",
            ...
            ["PhysicalMemoryBottomText"] = "Total XX GB",
            ["CommittedMemoryTopText"] = "Commit",
            ["CommittedMemoryBottomText"] = "Limite XX GB",
            ["WorkingSetPeakTopText"] = "Pic working set",
            ["WorkingSetPeakBottomText"] = "Actuel XX GB",
            ["PageFileTopText"] = "Fichier page",
            ["PageFileBottomText"] = "Total XX GB",
        ...
        Data["es"] = new(Data["en"])
        {
            ...
            ["DragLogReportHint"] = "Arrastre la ventana para redimensionar el log; arrastre el divisor para ajustar ancho",
            ...
            ["SaveUpstreamStderrText"] = "Guardar log upstream",
            ["SaveDownstreamStderrText"] = "Guardar log downstream",
            ["OpenOutputDirectoryText"] = "Abrir carpeta de salida",
            ["ViewEncodingCommandText"] = "Ver comando",
            ["InterruptUpstreamText"] = "Interrumpir upstream",
            ...
            ["PhysicalMemoryBottomText"] = "Total XX GB",
            ["CommittedMemoryTopText"] = "Confirmada",
            ["CommittedMemoryBottomText"] = "Límite XX GB",
            ["WorkingSetPeakTopText"] = "Pico working set",
            ["WorkingSetPeakBottomText"] = "Actual XX GB",
            ["PageFileTopText"] = "Archivo paginación",
            ["PageFileBottomText"] = "Total XX GB",
        ...
        Data["ja"] = new(Data["en"])
        {
            ...
            ["MemoryTitle"] = "RAM 使用量",
            ["StderrTitle"] = "プロセスログ",
            ["DragLogReportHint"] = "ウィンドウをドラッグしてログ領域を変更; 区切り線で幅を調整",
        ...
        Data["ru"] = new(Data["en"])
        {
            ...
            ["DragLogReportHint"] = "Перетащите окно для размера лога; перетащите разделитель для ширины",
            ...
            ["DistributionUpstreamLabel"] = "Upstream",
            ["DistributionDownstreamLabel"] = "Downstream",
            ...
            ["SaveUpstreamStderrText"] = "Сохранить upstream log",
            ["SaveDownstreamStderrText"] = "Сохранить downstream log",
            ["OpenOutputDirectoryText"] = "Открыть папку вывода",
            ["ViewEncodingCommandText"] = "Показать команду",
            ["InterruptUpstreamText"] = "Прервать upstream",
            ...
            ["WorkingSetPeakTopText"] = "Пик working set",
