...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["FilenameScribe.CheckInvalidChars"] = "No quote or control marks (\" ' ` < > | * ? \\ / : &)",
            ...
            ["FilenameScribe.SelfCheck2"] = "Ordering: Prefix S-E #s, pad 0s to double & higher digit consecutive #s",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["FilenameScribe.SelfCheck2"] = "剧集排序：序号、季度、集数前置，为十位或更高的连续值补零",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["FilenameScribe.SelfCheck2"] = "劇集排序：序號、季度、集數前置，為十位或更高的連續值補零",
