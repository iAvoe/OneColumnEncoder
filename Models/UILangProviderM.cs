...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            // FilterScribeModal
            ["SrcScribe.Description1"] = "Auto-builds Y4M pipe script based on imported video. You may paste more filters in, or copy them out",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["SrcScribe.Description1"] = "自动根据已导入的视频构建「生成 Y4M 流并导出」的脚本，可将需要的滤镜粘贴进来或拷出去",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["SrcScribe.Description1"] = "自動根據已導入的影片構建「生成 Y4M 流並導出」的腳本，可將需要的濾鏡黏貼進來或拷出去",
    ...
    private static void AddFrench() => Data["fr"] = new(Data["en"])
    {
        ...
        ["SrcScribe.Description1"] = "Génère automatiquement un script Y4M à partir d'une vidéo importée. Vous pouvez ajouter des filtres ou les copier",
    ...
    private static void AddSpanish() => Data["es"] = new(Data["en"])
    {
        ...
        ["SrcScribe.Description1"] = "Genera automáticamente un script de tubería Y4M basado en el vídeo importado. Puedes pegar más filtros o copiarlos",
    ...
    private static void AddJapanese() => Data["ja"] = new(Data["en"])
    {
        ...
        ["SrcScribe.Description1"] = "インポートした動画から Y4M 出力スクリプトを自動生成。必要なフィルターを貼り付けたりコピーしたりできます",
    ...
    private static void AddRussian() => Data["ru"] = new(Data["en"])
    {
        ...
        ["SrcScribe.Description1"] = "Авто-создает скрипт Y4M pipe на основе импортированного видео. Вы можете вставить дополнительные фильтры или скопировать их",
