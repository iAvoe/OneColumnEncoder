...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["FilenameScribe.CheckFtpSafe"] = "FTP-safe characters only (no control chars, emoji, or combining marks)",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["FilenameScribe.CheckFtpSafe"] = "不含控制符、Emoji、组合标记等 FTP 不兼容字符",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["FilenameScribe.CheckFtpSafe"] = "不含控制符、Emoji、組合標記等 FTP 不相容字元",
