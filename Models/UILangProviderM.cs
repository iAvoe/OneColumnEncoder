...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["FilenameScribe.Preview30Label"] = "PC and tablet file managers (30 chars)",
            ["FilenameScribe.Preview25Label"] = "Player title bar (25 chars)",
            ["FilenameScribe.Preview20Label"] = "Player sidebar / playlist (20 chars)",
            ["FilenameScribe.Preview15Label"] = "Small-screen phones (15 chars)",
            ...
            ["FilenameScribe.CheckExtendedChars"] = "No CJK text over BMP, Emoji or other ext. characters",
            ["FilenameScribe.CheckSpaces"] = "No spaces (use _ or - instead)",
            ["FilenameScribe.CheckCombiningMarks"] = "No Unicode combining marks",
            ["FilenameScribe.SelfCheckDate"] = "Self check: Use yyyy-mm-dd date format consistently",
            ["FilenameScribe.SelfCheckHeader"] = "Self check: media scraping compatibility",
            ["FilenameScribe.SelfCheckSeason"] = "Self check: Place order #, season-episode on the front",
            ["FilenameScribe.SelfCheckVersion"] = "Self check: Place version string at the end (ensure correct file order)",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["FilenameScribe.Preview30Label"] = "PC 与平板电脑文件管理器（30 字）",
            ["FilenameScribe.Preview25Label"] = "播放器标题栏（25 字）",
            ["FilenameScribe.Preview20Label"] = "播放器侧边栏 / 播放列表（20 字）",
            ["FilenameScribe.Preview15Label"] = "小屏幕手机端（15 字）",
            ...
            ["FilenameScribe.CheckExtendedChars"] = "不含超出 BMP 范围的 CJK 字符、颜文字、Emoji 等扩展字",
            ["FilenameScribe.CheckSpaces"] = "无空格（用 _ 或 - 替代）",
            ["FilenameScribe.CheckCombiningMarks"] = "不含 Unicode 组合附加符",
            ["FilenameScribe.SelfCheckDate"] = "自查：统一用 yyyy-mm-dd 日期格式",
            ["FilenameScribe.SelfCheckHeader"] = "自查：媒体刮削兼容性",
            ["FilenameScribe.SelfCheckSeason"] = "自查：序号与季集信息前置",
            ["FilenameScribe.SelfCheckVersion"] = "自查：版本号后置（不干扰排序）",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["FilenameScribe.Preview30Label"] = "PC 與平板電腦檔案管理器（30 字）",
            ["FilenameScribe.Preview25Label"] = "播放器標題列（25 字）",
            ["FilenameScribe.Preview20Label"] = "播放器側邊欄 / 播放列表（20 字）",
            ["FilenameScribe.Preview15Label"] = "小螢幕手機端（15 字）",
            ...
            ["FilenameScribe.CheckInvalidChars"] = "不含 \" < > | * ? / : & 等控制符",
            ["FilenameScribe.CheckExtendedChars"] = "不含超出 BMP 範圍的 CJK 字元、顏文字、Emoji 等擴充字",
            ["FilenameScribe.CheckSpaces"] = "無空格（用 _ 或 - 替代）",
            ["FilenameScribe.CheckCombiningMarks"] = "不含 Unicode 組合附加符",
            ["FilenameScribe.SelfCheckDate"] = "自查：統一用 yyyy-mm-dd 日期格式",
            ["FilenameScribe.SelfCheckHeader"] = "自查：媒體刮削相容性",
            ["FilenameScribe.SelfCheckSeason"] = "自查：序號與季集資訊前置",
            ["FilenameScribe.SelfCheckVersion"] = "自查：版本號後置（不干擾排序）",
