...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["SrcAnalysis.FrameCountSupplemented"] = "Missing nb_frames was supplemented for {0} video stream(s) using floor(duration * avg_frame_rate + 0.5).",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["Tool.Source.AviSynthQueue"] = "\U0001F5C1 AVS 腳本佇列",
            ["Tool.Source.VapourSynthQueue"] = "\U0001F5C1 VPY 腳本佇列",
            ["Tool.Source.SvfiQueue"] = "\U0001F5C1 SVFI 腳本佇列",
