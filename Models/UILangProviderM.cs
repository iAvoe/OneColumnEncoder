...
public class UILangProviderM
{
    ...
    private static void AddFrench() => Data["fr"] = new(Data["en"])
    {
        ...
        ["Tool.Source.VideoSrcConcat"] = "Concaténation source vidéo",
        ["Tool.Source.VideoSrcConcatWithCount"] = "Concaténation source vidéo ({0})",
    ...
    private static void AddSpanish() => Data["es"] = new(Data["en"])
    {
        ...
        ["Tool.Source.VideoSrcConcat"] = "Concat. fuente de vídeo",
        ["Tool.Source.VideoSrcConcatWithCount"] = "Concat. fuente de vídeo ({0})",
