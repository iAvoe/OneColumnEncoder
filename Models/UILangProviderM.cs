...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["ConfirmDialog.CopyHint"] = "Hint: Right-click on text to copy",
            ...
            ["FilenameScribe.AutoRuleVersion"] = "Automatic: version suffix does not interfere with sorting",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["ConfirmDialog.CopyHint"] = "注：右键单击文本以复制",
            ...
            ["FilenameScribe.AutoRuleDate"] = "自查：统一用 yyyy-mm-dd 日期格式",
            ["FilenameScribe.AutoRuleSeason"] = "自查：序号与季集信息前置",
            ["FilenameScribe.AutoRuleVersion"] = "自查：版本号不干扰排序",
            ["FilenameScribe.PasteFromClipboard"] = "从剪贴板粘贴",
            ["FilenameScribe.Cancel"] = "取消",
            ["FilenameScribe.Confirm"] = "确认",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["ConfirmDialog.CopyHint"] = "註：右鍵點擊文字以複製",
            ["ConfirmDialog.WarningPrefix"] = "警告：",
            ...
            ["FilenameScribe.AutoRuleDate"] = "自查：統一用 yyyy-mm-dd 日期格式",
            ["FilenameScribe.AutoRuleSeason"] = "自查：序號與季集資訊前置",
            ["FilenameScribe.AutoRuleVersion"] = "自查：版本號不干擾排序",
            ["FilenameScribe.PasteFromClipboard"] = "從剪貼簿貼上",
            ["FilenameScribe.Cancel"] = "取消",
            ["FilenameScribe.Confirm"] = "確認",
