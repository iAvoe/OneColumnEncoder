...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["Section.ImportSource"] = "4. Import or Create Source File",
            ...
            ["ReviseSourceResolution.SuggestedLabel"] = "From shrink generator",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["Section.ImportSource"] = "4. 导入或创建源文件",
            ...
            ["ReviseSourceResolution.SuggestedLabel"] = "来自缩小值生成器",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["Section.ImportSource"] = "4. 導入或創建源文件",
            ...
            ["ReviseSourceResolution.SuggestedLabel"] = "來自縮小值生成器",
            ["ReviseSourceResolution.UnknownResolution"] = "未知",
            ["ReviseSourceResolution.ResolutionFormat"] = "{0}x{1}",
            ["ReviseSourceResolution.Cancel"] = "取消",
            ["ReviseSourceResolution.Confirm"] = "更新 ffprobe JSON",
    ...
    private static void AddFrench() => Data["fr"] = new(Data["en"])
    {
        ...
        ["Section.ImportSource"] = "4. Importer/créer source",
        ["Section.SelectAnalytics"] = "5. Choisir analyseur vidéo",
        ...
        ["SourceQueue.FilterModeMessage"] = "Confirmer : sources de durée similaire, filtrage inutile\nAnnuler : exclure intros BDMV/M3U et bandes-annonces par vote pondéré\nUne comparaison du premier flux sera faite pour garder le format cohérent\n\nBDMV : utiliser d'abord BDInfo/ChapterTool pour détecter et corriger les épisodes mal segmentés",
        ...
        ["ReviseSourceResolution.SuggestedLabel"] = "Depuis le générateur",
    ...
    private static void AddSpanish() => Data["es"] = new(Data["en"])
    {
        ...
        ["AppConf.ClearOldQueueJson"] = "Limpiar datos antiguos de cola",
        ["AppConf.ClearOldQueueJsonTitle"] = "Limpiar datos antiguos de cola",
        ...
        ["Section.ImportSource"] = "4. Importar/crear fuente",
        ["Section.SelectAnalytics"] = "5. Elegir analizador",
        ...
        ["SourceQueue.FilterModeMessage"] = "Confirmar: fuentes de duración similar, sin filtrado\nCancelar: excluir intros BDMV/M3U y tráileres por voto ponderado\nSe comparará el primer flujo para mantener el formato coherente\n\nBDMV: usa primero BDInfo/ChapterTool para detectar y corregir episodios mal segmentados",
        ...
        ["ReviseSourceResolution.SuggestedLabel"] = "Desde generador",
    ...
    private static void AddJapanese() => Data["ja"] = new(Data["en"])
    {
        ...
        ["Section.ImportSource"] = "4. ソース取込/作成",
        ["Section.SelectAnalytics"] = "5. 解析ツール選択",
        ...
        ["SourceQueue.FilterModeMessage"] = "確認：各ソースの再生時間が近く、フィルタは不要です\nキャンセル：BDMV/M3U のイントロ・予告編を重み付き投票で除外します\n先頭ストリーム比較で形式の整合性を保ちます\n\nBDMV：まず BDInfo/ChapterTool で分割不良のエピソードを検出・修正します",
        ...
        ["ReviseSourceResolution.SuggestedLabel"] = "縮小ジェネレータ値",
    ...
    private static void AddRussian() => Data["ru"] = new(Data["en"])
    {
        ...
        ["Section.ImportSource"] = "4. Импорт/создание источника",
        ["Section.SelectAnalytics"] = "5. Выбор анализатора",
        ...
        ["SourceQueue.FilterModeMessage"] = "Подтвердить: длительность источников близка, фильтр не нужен\nОтмена: исключить интро и трейлеры BDMV/M3U взвешенным голосованием\nСравнение с первым потоком сохранит согласованность формата\n\nBDMV: сначала BDInfo/ChapterTool для выявления и исправления эпизодов с неверной сегментацией",
        ...
        ["ReviseSourceResolution.SuggestedLabel"] = "Из генератора",
