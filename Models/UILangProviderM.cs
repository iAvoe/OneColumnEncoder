...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["SrcScribe.ResolutionScaleTitle"] = "Resolution Scaling Parameter Generator",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["SrcScribe.ResolutionScaleTitle"] = "分辨率缩放命令生成器",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["SrcScribe.ResolutionScaleTitle"] = "解析度縮放命令生成器",
