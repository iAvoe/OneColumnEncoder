...
public class UILangProviderM
{
    ...
    private static void AddFrench() => Data["fr"] = new(Data["en"])
    {
        ...
        ["Buttons.BypassSrcChecklist"] = "Ignorer (débloquer Démarrer encodage)",
        ["Buttons.InspectEncPreProblems"] = "Voir préchecks encodeur",
        ["Buttons.BypassEncChecklist"] = "Ignorer (débloquer Démarrer encodage)",
        ["Buttons.Add"] = "Ajouter",
        ...
        ["SrcInspect.ColorPrimariesP1Text"] = "Les lecteurs reviennent souvent à BT.709 lorsque les métadonnées de primaires couleur sont absentes, mais de nombreux ensembles de primaires existent et un seul est correct pour la source.",
    ...
    private static void AddSpanish() => Data["es"] = new(Data["en"])
    {
        ...
        ["SrcInspect.ProgressiveP1Text"] = "Esta herramienta no puede inspeccionar patrones entre fotogramas para configurar filtros IVTC. Consulte https://iavoe.github.io/deint-ivtc-web-tutorial/HTML para orientación.",
    ...
    private static void AddRussian() => Data["ru"] = new(Data["en"])
    {
        ...
        ["Buttons.BypassSrcChecklist"] = "Обойти (разблокировать Начать кодирование)",
        ["Buttons.InspectEncPreProblems"] = "Предпроверки кодера",
        ["Buttons.BypassEncChecklist"] = "Обойти (разблокировать Начать кодирование)",
