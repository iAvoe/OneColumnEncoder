...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["Section.SelectAnalytics"] = "3. Select Video Analyzer",
            ["Section.SelectDependencies"] = "4. Select Dependencies",
            ["Section.ImportSource"] = "5. Import or Create Source File",
            ["Section.AnalysisResults"] = "6. Analysis Results",
            ["Section.EncodingConfigs"] = "7. Encoding Configurations",
            ["Section.StartEncoding"] = "8. Start Encoding",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["Section.SelectAnalytics"] = "3. 选择视频分析工具",
            ["Section.SelectDependencies"] = "4. 选择依赖文件",
            ["Section.ImportSource"] = "5. 导入或创建源文件",
            ["Section.AnalysisResults"] = "6. 视频源分析报告",
            ["Section.EncodingConfigs"] = "7. 配置编码选项",
            ["Section.StartEncoding"] = "8. 开始压制选项",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["Section.SelectAnalytics"] = "3. 選擇影片分析工具",
            ["Section.SelectDependencies"] = "4. 選擇依賴文件",
            ["Section.ImportSource"] = "5. 導入或創建源文件",
            ["Section.AnalysisResults"] = "6. 影片源分析報告",
            ["Section.EncodingConfigs"] = "7. 配置編碼選項",
            ["Section.StartEncoding"] = "8. 開始壓制選項",
    ...
    private static void AddFrench() => Data["fr"] = new(Data["en"])
    {
        ...
        ["Section.SelectAnalytics"] = "3. Choisir analyseur vidéo",
        ["Section.SelectDependencies"] = "4. Choisir dépendances",
        ["Section.ImportSource"] = "5. Importer/créer source",
        ["Section.AnalysisResults"] = "6. Résultats d'analyse",
        ["Section.EncodingConfigs"] = "7. Configurations d'encodage",
        ["Section.StartEncoding"] = "8. Démarrer encodage",
    ...
    private static void AddSpanish() => Data["es"] = new(Data["en"])
    {
        ...
        ["Section.SelectAnalytics"] = "3. Elegir analizador",
        ["Section.SelectDependencies"] = "4. Elegir dependencias",
        ["Section.ImportSource"] = "5. Importar/crear fuente",
        ["Section.AnalysisResults"] = "6. Resultados de análisis",
        ["Section.EncodingConfigs"] = "7. Configuración de codificación",
        ["Section.StartEncoding"] = "8. Iniciar codificación",
    ...
    private static void AddJapanese() => Data["ja"] = new(Data["en"])
    {
        ...
        ["Section.SelectAnalytics"] = "3. 解析ツール選択",
        ["Section.SelectDependencies"] = "4. 依存ファイル選択",
        ["Section.ImportSource"] = "5. ソース取込/作成",
        ["Section.AnalysisResults"] = "6. 解析結果",
        ["Section.EncodingConfigs"] = "7. エンコード設定",
        ["Section.StartEncoding"] = "8. エンコード開始",
    ...
    private static void AddRussian() => Data["ru"] = new(Data["en"])
    {
        ...
        ["Section.SelectAnalytics"] = "3. Выбор анализатора",
        ["Section.SelectDependencies"] = "4. Выбор зависимостей",
        ["Section.ImportSource"] = "5. Импорт/создание источника",
        ["Section.AnalysisResults"] = "6. Результаты анализа",
        ["Section.EncodingConfigs"] = "7. Настройки кодирования",
        ["Section.StartEncoding"] = "8. Запуск кодирования",
