...
public class UILangProviderM
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["Section.SelectDependencies"] = "Select Dependencies (when upstream is red) ",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["Section.SelectDependencies"] = "选择依赖文件（选中的上游程序泛红时）",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["Section.SelectDependencies"] = "選擇依賴文件（選取的上游程式泛紅時）",
    ...
    private static void AddFrench() => Data["fr"] = new(Data["en"])
    {
        ...
        ["Section.SelectDependencies"] = "Choisir dépendances (si amont rouge)",
    ...
    private static void AddSpanish() => Data["es"] = new(Data["en"])
    {
        ...
        ["Section.SelectDependencies"] = "Elegir dependencias (si aguas arriba está rojo)",
    ...
    private static void AddJapanese() => Data["ja"] = new(Data["en"])
    {
        ...
        ["Section.SelectDependencies"] = "依存ファイル選択 (上流が赤)",
    ...
    private static void AddRussian() => Data["ru"] = new(Data["en"])
    {
        ...
        ["Section.SelectDependencies"] = "Выбор зависимостей (Если апстрим красный)",
