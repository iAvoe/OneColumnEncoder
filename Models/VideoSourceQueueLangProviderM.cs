...
public class VideoSourceQueueLangProviderM
{
    private static readonly Dictionary<string, Dictionary<string, string>> Data = new()
    {
        ["en"] = new()
        {
            ...
            ["SourceQueue.AnalysisCompletedNoExcluded"] = "Queue source analysis completed. No videos were filtered out.\n\nQueue data JSON:\n{0}",
        ...
        ["zh-cn"] = new()
        {
            ...
            ["SourceQueue.AnalysisCompletedNoExcluded"] = "队列视频源分析已完成。未过滤掉视频。\n\n队列数据 JSON：\n{0}",
        ...
        ["zh-tw"] = new()
        {
            ...
            ["SourceQueue.AnalysisCompletedNoExcluded"] = "佇列視訊來源分析已完成。未過濾掉視訊。\n\n佇列資料 JSON：\n{0}",
            ["SourceQueue.CopyQueueJsonPath"] = "複製佇列 JSON 路徑",
            ["SourceQueue.CopyExcludedJsonPath"] = "複製排除列表 JSON 路徑",
            ["SourceQueue.OpenQueueJson"] = "開啟佇列 JSON",
    ...
    static VideoSourceQueueLangProviderM()
    {
        Data["fr"] = new(Data["en"])
        {
            ...
            ["SourceQueue.AnalysisCompleted"] = "Analyse de la file d'attente terminée. {0} vidéo(s) exclue(s) en raison de différences excessives.\n\nJSON des données de file d'attente :\n{1}\n\nListe d'exclusion :\n{2}",
            ["SourceQueue.AnalysisCompletedNoExcluded"] = "Analyse de la file d'attente terminée. Aucune vidéo exclue.\n\nJSON des données de file d'attente :\n{0}",
        ...
        Data["es"] = new(Data["en"])
        {
            ...
            ["SourceQueue.AnalysisCompleted"] = "Análisis de cola completado. Se filtraron {0} video(s) por diferencias excesivas.\n\nJSON de datos de cola:\n{1}\n\nLista de exclusión:\n{2}",
            ["SourceQueue.AnalysisCompletedNoExcluded"] = "Análisis de cola completado. No se filtraron vídeos.\n\nJSON de datos de cola:\n{0}",
        ...
        Data["ja"] = new(Data["en"])
        {
            ...
            ["SourceQueue.AnalysisCompleted"] = "キューソース分析が完了しました。差異が大きいため {0} 個の動画を除外しました。\n\nキューデータ JSON:\n{1}\n\n除外リスト:\n{2}",
            ["SourceQueue.AnalysisCompletedNoExcluded"] = "キューソース分析が完了しました。除外された動画はありません。\n\nキューデータ JSON:\n{0}",
        ...
        Data["ru"] = new(Data["en"])
        {
            ...
            ["SourceQueue.AnalysisCompleted"] = "Анализ очереди завершён. Отфильтровано {0} видео из-за чрезмерных различий.\n\nJSON данных очереди:\n{1}\n\nСписок исключённых:\n{2}",
            ["SourceQueue.AnalysisCompletedNoExcluded"] = "Анализ очереди завершён. Видео не отфильтрованы.\n\nJSON данных очереди:\n{0}",
    ...
    public VideoSourceQueueLangProviderM(string languageCode)
    {
        ...
        SourceQueueAnalysisCompleted = _d["SourceQueue.AnalysisCompleted"];
        SourceQueueAnalysisCompletedNoExcluded = _d["SourceQueue.AnalysisCompletedNoExcluded"];
