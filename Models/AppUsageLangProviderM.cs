...
public class AppUsageLangProviderM
{
    ...
    static AppUsageLangProviderM()
    {
        ...
        Data["es"] = new(Data["en"])
        {
            ...
            ["Step1"] = "1. Importe y seleccione una herramienta upstream (ffmpeg, vspipe, avs2yuv, etc.)",
            ["Step2"] = "2. Importe y seleccione un codificador / downstream (x264, x265, etc.)",
            ["Step3"] = "3. Importe el archivo de vídeo fuente",
            ["Step4"] = "4. Elija ajustes validados como compatibles y sanos",
            ["Step5"] = "5. Limpie la lista de comprobación e inicie",
        ...
        Data["ru"] = new(Data["en"])
        {
            ...
            ["Step1"] = "1. Импортируйте и выберите upstream-инструмент (ffmpeg, vspipe, avs2yuv и т. п.)",
            ["Step2"] = "2. Импортируйте и выберите кодер / downstream (x264, x265 и т. п.)",
            ["Step3"] = "3. Импортируйте исходный видеофайл",
            ["Step4"] = "4. Выберите настройки, проверенные на совместимость и состояние",
            ["Step5"] = "5. Пройдите checklist и запустите",
            ...
            ["ManualCrfTitle"] = "Ручные режимы rate control",
            ["ManualCrfList"] = "· Поддерживается только CRF. Диапазон=UHQ|HQ|Streaming|Lossless|Default\n· x264: 13~16 | 18~20 | 21~24 | 0 | 23\n· x265: 17~20 | 21~25 | 26~30 | 0 | 28\n· SVT-AV1: 28~32 | 33~36 | 37~40 | 1 | 35",
