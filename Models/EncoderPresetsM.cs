...
namespace OneColumnEncoder.Models
{
    ...
    public static class EncoderPresetsM
    {
        ...
        public static EncoderPresetItem? GetX264Preset(int key) =>
            X264Presets.FirstOrDefault(p => p.Key == key);

        public static EncoderPresetItem? GetX265Preset(int key) =>
            X265Presets.FirstOrDefault(p => p.Key == key);

        public static EncoderPresetItem? GetSvtAv1Preset(int key) =>
